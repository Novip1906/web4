...
// ---- ПРЕСЕТЫ ----
const PRESETS = [
  { id: 1, title: "Утка", model: "models/Duck.glb" },
  { id: 2, title: "Лиса", model: "models/Fox.glb" },
  { id: 3, title: "Шлем", model: "models/DamagedHelmet.glb" },
  { id: 4, title: "Авокадо", model: "models/Avocado.glb" },
  { id: 5, title: "Анимация: куб", model: "models/BoxAnimated.glb" },
  { id: 6, title: "Утка + Лиса", models: [
      { title: "Утка", model: "models/Duck.glb" },
      { title: "Лиса", model: "models/Fox.glb" },
    ]
  }
];
